...
f9000004:	1b018193          	addi	gp,gp,432 # f90011b0 <__global_pointer$>
...
f900000c:	9c810113          	addi	sp,sp,-1592 # f90029d0 <__freertos_irq_stack_top>

	/* Load data section */
	la a0, _data_lma
f9000010:	00001517          	auipc	a0,0x1
f9000014:	87850513          	addi	a0,a0,-1928 # f9000888 <_data>
	la a1, _data
f9000018:	00001597          	auipc	a1,0x1
f900001c:	87058593          	addi	a1,a1,-1936 # f9000888 <_data>
	la a2, _edata
f9000020:	81c18613          	addi	a2,gp,-2020 # f90009cc <__bss_start>
	bgeu a1, a2, 2f
...
2:
	...
	/* Clear bss section */
	la a0, __bss_start
f900003c:	81c18513          	addi	a0,gp,-2020 # f90009cc <__bss_start>
	la a1, _end
f9000040:	82018593          	addi	a1,gp,-2016 # f90009d0 <_end>
	bgeu a0, a1, 2f
...
f9000074:	81840413          	addi	s0,s0,-2024 # f9000888 <_data>
f9000078:	00001917          	auipc	s2,0x1
f900007c:	81090913          	addi	s2,s2,-2032 # f9000888 <_data>
...
f90000b0:	7dc40413          	addi	s0,s0,2012 # f9000888 <_data>
f90000b4:	00000917          	auipc	s2,0x0
f90000b8:	7d490913          	addi	s2,s2,2004 # f9000888 <_data>
...
f90001f4:	88878793          	addi	a5,a5,-1912 # f9000888 <__freertos_irq_stack_top+0xffffdeb8>
...
f9000248:	89c78793          	addi	a5,a5,-1892 # f900089c <__freertos_irq_stack_top+0xffffdecc>
...
f90003dc:	00068a63          	beqz	a3,f90003f0 <plic_set_enable+0x38>
        return *((volatile u32*) address);
f90003e0:	00052603          	lw	a2,0(a0) # f8010000 <__freertos_irq_stack_top+0xff00d630>
...
f900056c:	8b050513          	addi	a0,a0,-1872 # f90008b0 <__freertos_irq_stack_top+0xffffdee0>
...
f90005d0:	02e7a023          	sw	a4,32(a5) # f8015020 <__freertos_irq_stack_top+0xff012650>
...
f90005d8:	7f878793          	addi	a5,a5,2040 # f90007f8 <__freertos_irq_stack_top+0xffffde28>
...
f9000618:	8fc50513          	addi	a0,a0,-1796 # f90008fc <__freertos_irq_stack_top+0xffffdf2c>
...
f9000650:	91050513          	addi	a0,a0,-1776 # f9000910 <__freertos_irq_stack_top+0xffffdf40>
...
f90006c8:	01312623          	sw	s3,12(sp)
    bsp_init();
    bsp_printf("GPIO0 && UART demo ! \r\n");
f90006cc:	f9001537          	lui	a0,0xf9001
f90006d0:	92c50513          	addi	a0,a0,-1748 # f900092c <__freertos_irq_stack_top+0xffffdf5c>
f90006d4:	d81ff0ef          	jal	ra,f9000454 <bsp_printf>
    bsp_printf("onboard Water_LEDs is running \r\n");
f90006d8:	f9001537          	lui	a0,0xf9001
f90006dc:	94450513          	addi	a0,a0,-1724 # f9000944 <__freertos_irq_stack_top+0xffffdf74>
f90006e0:	d75ff0ef          	jal	ra,f9000454 <bsp_printf>
f90006e4:	f80157b7          	lui	a5,0xf8015
f90006e8:	00e00713          	li	a4,14
f90006ec:	00e7a423          	sw	a4,8(a5) # f8015008 <__freertos_irq_stack_top+0xff012638>
...
f9000708:	00f92223          	sw	a5,4(s2) # f8015004 <__freertos_irq_stack_top+0xff012634>
...
f90007d4:	f337d6e3          	bge	a5,s3,f9000700 <main+0x4c>
    ...
    bsp_printf("The program has finished running. \r\n");
f90007d8:	f9001537          	lui	a0,0xf9001
f90007dc:	96850513          	addi	a0,a0,-1688 # f9000968 <__freertos_irq_stack_top+0xffffdf98>
f90007e0:	c75ff0ef          	jal	ra,f9000454 <bsp_printf>
    bsp_printf("You have finish your first risc-v program  \r\n");
f90007e4:	f9001537          	lui	a0,0xf9001
f90007e8:	99050513          	addi	a0,a0,-1648 # f9000990 <__freertos_irq_stack_top+0xffffdfc0>
f90007ec:	c69ff0ef          	jal	ra,f9000454 <bsp_printf>

    init();
f90007f0:	d9dff0ef          	jal	ra,f900058c <init>
    while(1); 
f90007f4:	0000006f          	j	f90007f4 <main+0x140>
...
trap_entry:
  addi sp,sp, -16*4
f90007f8:	fc010113          	addi	sp,sp,-64
  sw x1,   0*4(sp)
f90007fc:	00112023          	sw	ra,0(sp)
  sw x5,   1*4(sp)
f9000800:	00512223          	sw	t0,4(sp)
  sw x6,   2*4(sp)
f9000804:	00612423          	sw	t1,8(sp)
  sw x7,   3*4(sp)
f9000808:	00712623          	sw	t2,12(sp)
  sw x10,  4*4(sp)
f900080c:	00a12823          	sw	a0,16(sp)
  sw x11,  5*4(sp)
f9000810:	00b12a23          	sw	a1,20(sp)
  sw x12,  6*4(sp)
f9000814:	00c12c23          	sw	a2,24(sp)
  sw x13,  7*4(sp)
f9000818:	00d12e23          	sw	a3,28(sp)
  sw x14,  8*4(sp)
f900081c:	02e12023          	sw	a4,32(sp)
  sw x15,  9*4(sp)
f9000820:	02f12223          	sw	a5,36(sp)
  sw x16, 10*4(sp)
f9000824:	03012423          	sw	a6,40(sp)
  sw x17, 11*4(sp)
f9000828:	03112623          	sw	a7,44(sp)
  sw x28, 12*4(sp)
f900082c:	03c12823          	sw	t3,48(sp)
  sw x29, 13*4(sp)
f9000830:	03d12a23          	sw	t4,52(sp)
  sw x30, 14*4(sp)
f9000834:	03e12c23          	sw	t5,56(sp)
  sw x31, 15*4(sp)
f9000838:	03f12e23          	sw	t6,60(sp)
  call trap
f900083c:	e45ff0ef          	jal	ra,f9000680 <trap>
  lw x1 ,  0*4(sp)
f9000840:	00012083          	lw	ra,0(sp)
  lw x5,   1*4(sp)
f9000844:	00412283          	lw	t0,4(sp)
  lw x6,   2*4(sp)
f9000848:	00812303          	lw	t1,8(sp)
  lw x7,   3*4(sp)
f900084c:	00c12383          	lw	t2,12(sp)
  lw x10,  4*4(sp)
f9000850:	01012503          	lw	a0,16(sp)
  lw x11,  5*4(sp)
f9000854:	01412583          	lw	a1,20(sp)
  lw x12,  6*4(sp)
f9000858:	01812603          	lw	a2,24(sp)
  lw x13,  7*4(sp)
f900085c:	01c12683          	lw	a3,28(sp)
  lw x14,  8*4(sp)
f9000860:	02012703          	lw	a4,32(sp)
  lw x15,  9*4(sp)
f9000864:	02412783          	lw	a5,36(sp)
  lw x16, 10*4(sp)
f9000868:	02812803          	lw	a6,40(sp)
  lw x17, 11*4(sp)
f900086c:	02c12883          	lw	a7,44(sp)
  lw x28, 12*4(sp)
f9000870:	03012e03          	lw	t3,48(sp)
  lw x29, 13*4(sp)
f9000874:	03412e83          	lw	t4,52(sp)
  lw x30, 14*4(sp)
f9000878:	03812f03          	lw	t5,56(sp)
  lw x31, 15*4(sp)
f900087c:	03c12f83          	lw	t6,60(sp)
  addi sp,sp, 16*4
f9000880:	04010113          	addi	sp,sp,64
  mret
f9000884:	30200073          	mret
