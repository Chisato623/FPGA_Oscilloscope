...
module EfxSapphireSoc (
  ...
  (* keep_hierarchy = "TRUE" *) BufferCC_4 userInterruptA_buffercc (
  ...
  (* keep_hierarchy = "TRUE" *) BufferCC_6 system_cores_0_debugReset_asyncAssertSyncDeassert_buffercc (
...
//BufferCC_5 replaced by BufferCC_4
