...
module edb_top (
    ...
    edb_la_top #(
        ...
        .INPUT_PIPE_STAGES      ( 1 ),
        .CAPTURE_CONTROL    ( 0 ),
        .UUID   ( 128'h41ea44ff27424fc6a3404693c24b0d70 ),
        .CNDTNL_STRG_EN     ( 0 ),
        .PROBE0_WIDTH       ( 8 ),
        .PROBE0_TYPE        ( 1 ),
        .PROBE1_WIDTH       ( 8 ),
...
module trigger_skipper #(
    ...
    reg [N_WIDTH-1:0]total_number_of_trigger_count = 'd0;
    
    always @(posedge clk) begin
        if(!resetn) begin 
            total_number_of_trigger_count <= 'd0;
            trigger_out <= 1'b0;
        end else if (trigger_in) begin 
            if (total_number_of_trigger_count == (skip_count-1)) begin 
                total_number_of_trigger_count <= 'd0;
                trigger_out <= 1'b1;
            end else begin 
                total_number_of_trigger_count <= total_number_of_trigger_count + 1'b1;
            end
        end 
    end
