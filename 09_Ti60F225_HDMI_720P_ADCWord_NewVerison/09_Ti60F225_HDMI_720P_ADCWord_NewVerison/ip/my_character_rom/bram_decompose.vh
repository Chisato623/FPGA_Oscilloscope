localparam TOTAL_SIZE_A = 512;
localparam TOTAL_SIZE_B = 512;
...
case (index)
   0: bram_decompose_table=(val_==0)?   0:(val_==1)?   0:(val_==2)?   4:(val_==3)?   0:(val_==4)?   0:0;
   endcase
endfunction  
...
case (index)
   0: bram_mapping_table=(val_== 0)?   0:(val_== 1)?   0:(val_== 2)?  19:(val_== 3)?   0:(val_== 4)?   0:(val_== 5)?   0:(val_== 6)?   0:(val_== 7)?   0:(val_== 8)?   0:(val_== 9)?  19:(val_==10)?   0:(val_==11)?   0:(val_==12)?   0:(val_==13)?   0:(val_==14)?   0:(val_==15)?   0:(val_==16)?   9:(val_==17)?  20:(val_==18)?   9:(val_==19)?  20:0;
   1: bram_mapping_table=(val_== 0)?   0:(val_== 1)?   1:(val_== 2)?  39:(val_== 3)?  20:(val_== 4)?   0:(val_== 5)?   0:(val_== 6)?   0:(val_== 7)?   0:(val_== 8)?   0:(val_== 9)?  39:(val_==10)?  20:(val_==11)?   0:(val_==12)?   0:(val_==13)?   0:(val_==14)?   0:(val_==15)?   0:(val_==16)?   9:(val_==17)?  20:(val_==18)?   9:(val_==19)?  20:0;
   2: bram_mapping_table=(val_== 0)?   0:(val_== 1)?   2:(val_== 2)?  59:(val_== 3)?  40:(val_== 4)?   0:(val_== 5)?   0:(val_== 6)?   0:(val_== 7)?   0:(val_== 8)?   0:(val_== 9)?  59:(val_==10)?  40:(val_==11)?   0:(val_==12)?   0:(val_==13)?   0:(val_==14)?   0:(val_==15)?   0:(val_==16)?   9:(val_==17)?  20:(val_==18)?   9:(val_==19)?  20:0;
   3: bram_mapping_table=(val_== 0)?   0:(val_== 1)?   3:(val_== 2)?  63:(val_== 3)?  60:(val_== 4)?   0:(val_== 5)?   0:(val_== 6)?   0:(val_== 7)?   0:(val_== 8)?   0:(val_== 9)?  63:(val_==10)?  60:(val_==11)?   0:(val_==12)?   0:(val_==13)?   0:(val_==14)?   0:(val_==15)?   0:(val_==16)?   9:(val_==17)?  20:(val_==18)?   9:(val_==19)?  20:0;
   endcase
endfunction  
